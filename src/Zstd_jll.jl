...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Zstd_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3161d3a3-bdf6-5164-811a-617609db77b4"))
...
if best_platform === nothing
    @debug("Unable to load Zstd; unsupported platform $(triplet(platform_key_abi()))")
else
